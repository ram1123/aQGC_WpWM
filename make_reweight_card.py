...
for i in range(-5,6):
     ...
     print "        set anoinputs 1 " +str(i*0.5) + "00000e-11"

#FS1
for i in range(-5,6):
     print "launch"
     print "        set anoinputs 12 0.000000e+00"
     print "        set anoinputs 2 " +str(i*0.1) + "00000e-10"

#FM0
for i in range(-5,6):
     print "launch"
     print "        set anoinputs 12 0.000000e+00"
     print "        set anoinputs 3 " +str(i*0.5) + "00000e-11"

#FM1
for i in range(-5,6):
     print "launch"
     print "        set anoinputs 12 0.000000e+00"
     print "        set anoinputs 4 " +str(i*0.5) + "00000e-11"

#FM6
for i in range(-5,6):
     print "launch"
     print "        set anoinputs 12 0.000000e+00"
     print "        set anoinputs 9 " +str(i*0.5) + "00000e-11"

#FM7
for i in range(-5,6):
     print "launch"
     print "        set anoinputs 12 0.000000e+00"
     print "        set anoinputs 10 " +str(i*0.1) + "00000e-10"     

#FT0
for i in range(-5,6):
     print "launch"
     print "        set anoinputs 12 0.000000e+00"
     print "        set anoinputs 11 " +str(i*0.5) + "00000e-12"

#FT1
for i in range(-5,6):
     print "launch"
     print "        set anoinputs 12 " +str(i*0.2) + "00000e-12"          
